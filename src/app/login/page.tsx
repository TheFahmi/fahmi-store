        ...
        <div>
          ...
          <div className="mt-8 flex items-center gap-6">
            <div>
              ...
              <p className="text-[12px] text-background/60">Happy customers</p>
            </div>
            <div className="w-px h-10 bg-white/15" />
            <div>
              <p className="text-2xl font-semibold">4.9</p>
              <p className="text-[12px] text-background/60">Average rating</p>
            </div>
            <div className="w-px h-10 bg-white/15" />
            <div>
              <p className="text-2xl font-semibold">500+</p>
              <p className="text-[12px] text-background/60">Products</p>
            </div>
          </div>
        </div>
