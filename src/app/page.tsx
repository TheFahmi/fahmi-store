          ...
          <div className="text-center max-w-xl mx-auto">
            ...
            <form className="mt-6 flex flex-col sm:flex-row gap-2 max-w-lg mx-auto" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="flex-1 h-14 px-5 rounded-full bg-black/5 dark:bg-white/10 text-foreground dark:text-white text-[17px] placeholder:text-muted-foreground dark:placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-[#0071e3] border-2 border-black/10 dark:border-white/20"
              />
              <button
                type="submit"
